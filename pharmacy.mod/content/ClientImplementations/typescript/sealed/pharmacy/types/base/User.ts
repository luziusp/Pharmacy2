...
import {User as concrete_User} from '../User';
import * as Long from 'long';

export abstract class User {

    public static readonly __typeId: string = "43dd91d2-5d2b-11e9-8e99-4bbbc6df7cad";
    public static readonly __typeName: string = "pharmacy.User";
    ...
    public get __typeId(): string {
        return User.__typeId;
    }

    public get __typeName(): string {
        return User.__typeName;
    }
    ...
    public static fromJson (json: {}):concrete_User {
        if (!json) return null;

        let object = new concrete_User();
        object.setJson(json);
